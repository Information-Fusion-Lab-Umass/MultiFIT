...
#         features = self.LL(features)
        ...
        features = self.get_imputed_feats(data[id_][0], data[id_][1], data[id_][2],self.dict_selected_feats)
    ...
    def get_imputed_feats(self, feats, flags, time_steps, dict_selected_feats):
